...
namespace WedBanHang.Models
{
    public class sanpham
    {
        ...
        public static List<string> GetAllImageName(String nameFolder)
        {
            ...
            String searchFolder = @"C:\Users\phand\Desktop\PTPM_UDTM-master\PTPM_UDTM-master\PTPM_UDTM\WedBanHang\WedBanHang\Models\anhsp\anhdoanweb\" + nameFolder;
        ...
        public bool kiemTraTenPhuHop(string ten)
        {
            if (tensp.Equals(ten))
            {
                return true;
