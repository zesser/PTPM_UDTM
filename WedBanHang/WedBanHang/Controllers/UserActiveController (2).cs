    ...
    public class UserActiveController : Controller
    {
        ...
        public ActionResult XuLyLogin(FormCollection col)
        {
            ...
            else
            {
                ...
                Session["UserDN"] = new Muser() { MaKH = tbl_Khach.MAKHACHHANG.ToString(), mUsername = tbl_Khach.TENDN, TenKH = tbl_Khach.TENKHACHHANG, DiaChi = tbl_Khach.DIACHI, DienThoai = tbl_Khach.DIENTHOAI, Email = tbl_Khach.EMAIL };
